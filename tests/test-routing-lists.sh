...
assert "wb.ru" in priority_direct_domains["rules"][0]["domain_suffix"]
assert "wbbasket.ru" in priority_direct_domains["rules"][0]["domain_suffix"]
assert "wbcontent.net" in priority_direct_domains["rules"][0]["domain_suffix"]
assert "ozone.ru" in priority_direct_domains["rules"][0]["domain_suffix"]
assert "ozonusercontent.com" in priority_direct_domains["rules"][0]["domain_suffix"]
...
assert "wb.ru" in direct_domains["rules"][0]["domain_suffix"]
assert "wbbasket.ru" in direct_domains["rules"][0]["domain_suffix"]
assert "wbcontent.net" in direct_domains["rules"][0]["domain_suffix"]
assert "ozone.ru" in direct_domains["rules"][0]["domain_suffix"]
assert "ozonusercontent.com" in direct_domains["rules"][0]["domain_suffix"]
